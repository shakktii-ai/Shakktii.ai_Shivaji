...
//         डेमो मतदानासाठी पण्याची टाकी निशाणी समोरील निळे बटन दाबावे
//     </button>
//     <p className="text-md font-medium mt-6">
//         मतदानाच्या दिवशी सुद्धा <span className="font-bold">पण्याची टाकी</span> या चिन्हासमोरील बटन दाबून <span className="font-bold">भरत मारुती गोगावले</span> यांना प्रचंड मतांनी विजयी करा !
//     </p>
...
//         “पण्याची टाकी” या चिन्हासमोरील बटन दाबून प्रचंड मतांनी विजयी करा.
//     </p>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.शिवाजीराो शटुप्पा पाटील.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        271-चंदगड विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          मतदानाच्या दिवशी सुद्धा <span className="font-bold">पण्याची टाकी</span> या
          चिन्हासमोरील बटन दाबून{" "}
          <span className="font-bold">श्री.शिवाजीराो शटुप्पा पाटील</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
      ...
      <tr>
              <td className="border-2 border-black p-2 text-center text-xl font-bold">१६.</td>
              <td className="border-2 border-black text-center text-sm font-bold w-65">
              श्री.शिवाजीराो शटुप्पा पाटील.
              </td>
              <td className="border-2 border-black text-center w-16">
                <img src="/Shivaji.jpg" className=" m-auto" />
              </td>
              <td className="border-2 border-black text-center w-16">
                <img src="/watertank.png" className=" m-auto" />
              </td>
